...
public class PreferredDomains extends AppCompatActivity {
    BarChart bar_chart;
    PieChart pie_chart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preferred_domains);
        ...
        pieEntries.add(new PieEntry(4, "Technology and IT"));
        pieEntries.add(new PieEntry(2, "Medicine and healthcare"));
        pieEntries.add(new PieEntry(1, "Marketing and advertising"));
        pieEntries.add(new PieEntry(1, "Engineering and construction"));
        pieEntries.add(new PieEntry(2, "Human resources and personnel management"));
        pieEntries.add(new PieEntry(2, "Education"));
        pieEntries.add(new PieEntry(1, "Finance and accounting"));
        pieEntries.add(new PieEntry(1, "Sales and customer relations"));
        pieEntries.add(new PieEntry(2, "Consulting"));
        pieEntries.add(new PieEntry(2, "Manufacturing and production"));
        pieEntries.add(new PieEntry(1, "Others"));
