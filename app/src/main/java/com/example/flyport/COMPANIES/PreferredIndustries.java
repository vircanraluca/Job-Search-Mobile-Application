...
public class PreferredIndustries extends AppCompatActivity {
    BarChart bar_chart;
    PieChart pie_chart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preferred_industries);
        ...
        pieEntries.add(new PieEntry(2, "Healthcare and medicine"));
        pieEntries.add(new PieEntry(1, "Marketing and advertising"));
        pieEntries.add(new PieEntry(1, "Media and communications"));
        pieEntries.add(new PieEntry(2, "Engineering"));
        pieEntries.add(new PieEntry(2, "Finance and banking"));
