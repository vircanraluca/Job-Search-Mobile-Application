...
public class PreferredJobType extends AppCompatActivity {
    BarChart bar_chart;
    PieChart pie_chart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preferred_job_type);
        ...
        pieEntries.add(new PieEntry(5, "Part-Time"));
        pieEntries.add(new PieEntry(7, "Full-Time"));
