...
public class UsersByExperienceLevel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_users_by_experience_level);
        ...
        pieEntries.add(new PieEntry(3, "Entry-level"));
        pieEntries.add(new PieEntry(1, "No required"));
        pieEntries.add(new PieEntry(2, "Mid-level"));
        pieEntries.add(new PieEntry(5, "Senior"));
