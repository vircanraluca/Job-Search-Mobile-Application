            ...
            public void onClick(View v) {
                ...
                filterQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        // Aici poți face ce dorești cu lista matchingJobs

                        // Aici puteți face ce doriți cu lista matchingJobs, cum ar fi afișarea lor într-un RecyclerView sau în alt mod dorit
